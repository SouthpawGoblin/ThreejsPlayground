...
!function(global) {
    ...
    var RotateCube = global.RotateCube = function() {
        this.options = null;
        this.parentDom = null;
        this.scene = null;
        this.camera = null;
    ...
    RotateCube.prototype.init = function(parentDom, options, callback) {
    ...
    RotateCube.prototype.render = function(callback) {
        var self = this;
    ...
    RotateCube.prototype.dispose = function(callback) {
